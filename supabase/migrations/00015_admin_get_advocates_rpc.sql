...
-- SECURITY DEFINER RPC so admin panel bypasses RLS entirely
-- Returns all non-admin profiles with pagination + search + status filter
CREATE OR REPLACE FUNCTION admin_get_advocates(
